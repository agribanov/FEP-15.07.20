...
module.exports.build = parallel(copyHtml, copyCss, copyVendorsJs, copyVendorCss, copyJs);

module.exports.serve = series(copyHtml, copyCss, copyVendorsJs, copyVendorCss, copyJs, server);
